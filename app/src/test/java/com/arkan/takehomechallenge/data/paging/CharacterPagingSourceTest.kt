...
class CharacterPagingSourceTest {
    ...
    private lateinit var paging: CharacterPagingSource
    ...
    fun setUp() {
        ...
        paging = CharacterPagingSource(ds)
    }

    @Test
    fun loadSuccess() {
        coEvery { ds.getAllCharacter(1) } returns
            mockk {
    ...
    @Test
    fun loadError() {
        coEvery { ds.getAllCharacter(any()) } throws Exception("Mock Error")
